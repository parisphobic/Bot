  ...
  cooldown: 5000,
   ...
   async slashExecute(Bot, interaction) {
    try{
     ...
     DmEmbed.setAuthor({ name: KickUser.tag, iconURL: KickUser.displayAvatarURL({dynamic: true}) })
     ...
     KickEmbed.setDescription(`:white_check_mark: | <@${KickUser.id}> has been kicked from ${interaction.guild.name} \n Reasoning: ${Reason} `)
     KickEmbed.setAuthor({ name: interaction.user.tag, iconURL: interaction.user.displayAvatarURL({dynamic: true}) })
